...
const struct NatureInfo gNaturesInfo[NUM_NATURES] =
{
    [NATURE_HARDY] =
    {
        .name = COMPOUND_STRING("Hardy (Neutral)"),
        .statUp = STAT_ATK,
        .statDown = STAT_ATK,
        .backAnim = 0,
    ...
    [NATURE_LONELY] =
    {
        .name = COMPOUND_STRING("Lonely (+Atk -Def)"),
        .statUp = STAT_ATK,
        .statDown = STAT_DEF,
        .backAnim = 2,
    ...
    [NATURE_BRAVE] =
    {
        .name = COMPOUND_STRING("Brave (+Atk -Spe)"),
        .statUp = STAT_ATK,
        .statDown = STAT_SPEED,
        .backAnim = 0,
    ...
    [NATURE_ADAMANT] =
    {
        .name = COMPOUND_STRING("Adamant (+Atk -SpA)"),
        .statUp = STAT_ATK,
        .statDown = STAT_SPATK,
        .backAnim = 0,
    ...
    [NATURE_NAUGHTY] =
    {
        .name = COMPOUND_STRING("Naughty (+Atk -SpD)"),
        .statUp = STAT_ATK,
        .statDown = STAT_SPDEF,
        .backAnim = 0,
    ...
    [NATURE_BOLD] =
    {
        .name = COMPOUND_STRING("Bold (+Def -Atk)"),
        .statUp = STAT_DEF,
        .statDown = STAT_ATK,
        .backAnim = 1,
    ...
    [NATURE_DOCILE] =
    {
        .name = COMPOUND_STRING("Docile (Neutral)"),
        .statUp = STAT_DEF,
        .statDown = STAT_DEF,
        .backAnim = 1,
    ...
    [NATURE_RELAXED] =
    {
        .name = COMPOUND_STRING("Relaxed (+Def -Spe)"),
        .statUp = STAT_DEF,
        .statDown = STAT_SPEED,
        .backAnim = 1,
    ...
    [NATURE_IMPISH] =
    {
        .name = COMPOUND_STRING("Impish (+Def -SpA)"),
        .statUp = STAT_DEF,
        .statDown = STAT_SPATK,
        .backAnim = 0,
    ...
    [NATURE_LAX] =
    {
        .name = COMPOUND_STRING("Lax (+Def -SpD)"),
        .statUp = STAT_DEF,
        .statDown = STAT_SPDEF,
        .backAnim = 1,
    ...
    [NATURE_TIMID] =
    {
        .name = COMPOUND_STRING("Timid (+Spe -Atk)"),
        .statUp = STAT_SPEED,
        .statDown = STAT_ATK,
        .backAnim = 2,
    ...
    [NATURE_HASTY] =
    {
        .name = COMPOUND_STRING("Hasty (+Spe -Def)"),
        .statUp = STAT_SPEED,
        .statDown = STAT_DEF,
        .backAnim = 0,
    ...
    [NATURE_SERIOUS] =
    {
        .name = COMPOUND_STRING("Serious (Neutral)"),
        .statUp = STAT_SPEED,
        .statDown = STAT_SPEED,
        .backAnim = 1,
    ...
    [NATURE_JOLLY] =
    {
        .name = COMPOUND_STRING("Jolly (+Spe -SpA)"),
        .statUp = STAT_SPEED,
        .statDown = STAT_SPATK,
        .backAnim = 0,
    ...
    [NATURE_NAIVE] =
    {
        .name = COMPOUND_STRING("Naive (+Spe -SpD)"),
        .statUp = STAT_SPEED,
        .statDown = STAT_SPDEF,
        .backAnim = 0,
    ...
    [NATURE_MODEST] =
    {
        .name = COMPOUND_STRING("Modest (+SpA -Atk)"),
        .statUp = STAT_SPATK,
        .statDown = STAT_ATK,
        .backAnim = 2,
    ...
    [NATURE_MILD] =
    {
        .name = COMPOUND_STRING("Mild (+SpA -Def)"),
        .statUp = STAT_SPATK,
        .statDown = STAT_DEF,
        .backAnim = 2,
    ...
    [NATURE_QUIET] =
    {
        .name = COMPOUND_STRING("Quiet (+SpA -Spe)"),
        .statUp = STAT_SPATK,
        .statDown = STAT_SPEED,
        .backAnim = 2,
    ...
    [NATURE_BASHFUL] =
    {
        .name = COMPOUND_STRING("Bashful (Neutral)"),
        .statUp = STAT_SPATK,
        .statDown = STAT_SPATK,
        .backAnim = 2,
    ...
    [NATURE_RASH] =
    {
        .name = COMPOUND_STRING("Rash (+SpA -SpD)"),
        .statUp = STAT_SPATK,
        .statDown = STAT_SPDEF,
        .backAnim = 1,
    ...
    [NATURE_CALM] =
    {
        .name = COMPOUND_STRING("Calm (+SpD -Atk)"),
        .statUp = STAT_SPDEF,
        .statDown = STAT_ATK,
        .backAnim = 1,
    ...
    [NATURE_GENTLE] =
    {
        .name = COMPOUND_STRING("Gentle (+SpD -Def)"),
        .statUp = STAT_SPDEF,
        .statDown = STAT_DEF,
        .backAnim = 2,
    ...
    [NATURE_SASSY] =
    {
        .name = COMPOUND_STRING("Sassy (+SpD -Spe)"),
        .statUp = STAT_SPDEF,
        .statDown = STAT_SPEED,
        .backAnim = 1,
    ...
    [NATURE_CAREFUL] =
    {
        .name = COMPOUND_STRING("Careful (+SpD -SpA)"),
        .statUp = STAT_SPDEF,
        .statDown = STAT_SPATK,
        .backAnim = 2,
    ...
    [NATURE_QUIRKY] =
    {
        .name = COMPOUND_STRING("Quirky (Neutral)"),
        .statUp = STAT_SPDEF,
        .statDown = STAT_SPDEF,
        .backAnim = 1,
