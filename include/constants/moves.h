...
// Scrambled move renames/aliases
#define MOVE_CREEPING_STRIKE MOVE_SKITTER_SMACK
#define MOVE_HELL_THRUST MOVE_FALSE_SURRENDER
#define MOVE_HOODWINK MOVE_COVET
#define MOVE_JAGGED_EDGE MOVE_CRUSH_CLAW
#define MOVE_LACERATION MOVE_METAL_CLAW
#define MOVE_MOLT MOVE_SHELTER
#define MOVE_PUMMEL MOVE_POUND
#define MOVE_SACRED_SLASH MOVE_SACRED_SWORD
#define MOVE_SEDIMEND MOVE_SHORE_UP
#define MOVE_SPIKE_CANNON_SCRAMBLED MOVE_FURY_ATTACK
#define MOVE_WALLOP MOVE_TACKLE
